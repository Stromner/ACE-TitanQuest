...
import tq.character.editor.copied.code.core.UnhandledRuntimeException;
...
public abstract class FileParser {
    private static final Logger log = LoggerFactory.getLogger(FileParser.class.getName());
    ...
    void readString(VariableInfo variableInfo, boolean utf16le) {
        if (variableInfo.getValSize() != -1) {
            log.error(BUG_VARIABLESIZE_ERROR_MSG);
            return;
        }
